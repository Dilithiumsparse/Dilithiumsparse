...
#define pack_pk_t1_compact DILITHIUM_NAMESPACE(pack_pk_t1_compact)         
...
#define pack_sk_t0_compact DILITHIUM_NAMESPACE(pack_sk_t0_compact)
...
#define unpack_sk_sparse DILITHIUM_NAMESPACE(unpack_sk_sparse)
...
#define unpack_sig_compact DILITHIUM_NAMESPACE(unpack_sig_compact)
