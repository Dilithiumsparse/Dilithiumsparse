...
#define polyveck_power2round_compact DILITHIUM_NAMESPACE(polyveck_power2round_compact)
void polyveck_power2round_compact(int16_t v1[K][N], int16_t v0[K][N], const polyveck *v);
